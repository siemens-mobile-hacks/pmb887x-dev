...
int main(void) {
	...
	#if defined(BOARD_PANASONIC_VS7)
	GPIO_PIN(GPIO_KP_IN0) = GPIO_IS_ALT0 | GPIO_PDPU_PULLUP | GPIO_PPEN_OPENDRAIN;
	GPIO_PIN(GPIO_KP_IN1) = GPIO_IS_ALT0 | GPIO_PDPU_PULLUP | GPIO_PPEN_OPENDRAIN;
	GPIO_PIN(GPIO_KP_IN2) = GPIO_IS_ALT0 | GPIO_PDPU_PULLUP | GPIO_PPEN_OPENDRAIN;
	GPIO_PIN(GPIO_KP_IN3) = GPIO_IS_ALT0 | GPIO_PDPU_PULLUP | GPIO_PPEN_OPENDRAIN;
	GPIO_PIN(GPIO_KP_IN4) = GPIO_OS_ALT1 | GPIO_PPEN_OPENDRAIN;
	GPIO_PIN(GPIO_KP_IN5) = GPIO_OS_ALT1 | GPIO_PPEN_OPENDRAIN;
	GPIO_PIN(GPIO_KP_IN6) = GPIO_OS_ALT1 | GPIO_PPEN_OPENDRAIN;
	GPIO_PIN(GPIO_SSC2_SCLK) = GPIO_IS_ALT3 | GPIO_PDPU_PULLUP | GPIO_PPEN_OPENDRAIN;
	#else
	GPIO_PIN(GPIO_KP_IN0) = GPIO_IS_ALT0 | GPIO_PDPU_PULLUP | GPIO_ENAQ_ON;
	GPIO_PIN(GPIO_KP_IN1) = GPIO_IS_ALT0 | GPIO_PDPU_PULLUP | GPIO_ENAQ_ON;
	GPIO_PIN(GPIO_KP_IN2) = GPIO_IS_ALT0 | GPIO_PDPU_PULLUP | GPIO_ENAQ_ON;
