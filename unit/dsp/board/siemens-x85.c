...
#define CGU_CON2_BASE_MASK 0x00001370
#define CGU_CON2_BASE_CONFIGURATION 0x00000070
#define CGU_CON2_TPU_CLOCK_ENABLE BIT(13)
#define CGU_L1_CLOCK_MASK 0x00001370
...
#define CGU_CON3_PERIPHERAL_CLOCK_ENABLE BIT(28)
...
static bool configure_system_clocks(void) {
	...
	PLL_CON3 |= CGU_CON3_PERIPHERAL_CLOCK_ENABLE;
	PLL_CON2 |= CGU_CON2_TPU_CLOCK_ENABLE;
