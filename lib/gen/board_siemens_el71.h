...
#define	GPIO_DISP_CD			GPIO_DIF_CD
#define	GPIO_DISP_CS1			GPIO_DIF_CS1
#define	GPIO_DISP_RESET1		GPIO_DIF_RESET1
...
#define	GPIO_DISP_WR			GPIO_DIF_WR
#define	GPIO_DISP_RD			GPIO_DIF_RD
